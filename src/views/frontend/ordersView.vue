<template>
  ...
  <div class="accordion" id="personalInfo">
  <div class="accordion-item bg-white border border-gray-200">
    <h2 class="accordion-header mb-0" id="headingOne">
      ...
      " type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true"
        ...
        <font-awesome-icon class="w-5 h-5 text-gray-600 mr-2" icon="fa-solid fa-angle-down"></font-awesome-icon>  訂購人資訊
      </button>
    </h2>
  ...
  <div class="accordion-item bg-white border border-gray-200">
    <h2 class="accordion-header mb-0" id="header">
      ...
      " type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true"
        aria-controls="collapseOne">
        <font-awesome-icon class="w-5 h-5 text-gray-600 mr-2" icon="fa-solid fa-angle-down"></font-awesome-icon>  購買明細
      </button>
    </h2>
    <div id="collapseOne" class="accordion-collapse collapse show " aria-labelledby="headingOne"
      data-bs-parent="#accordionExample">
                ...
                <li v-for="(item) in cartProducts" :key="item.id" class="flex justify-center w-full">
                  <div class="grid grid-cols-4 gap-4 rounded-lg bg-white shadow  w-full">
                    <div class="p-1  col-span-2">
                      <img class="w-full h-28 object-cover rounded " :src="item.product.imageUrl" :alt="item.product_id" />
                    </div>
